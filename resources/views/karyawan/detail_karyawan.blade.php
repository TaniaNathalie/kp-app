            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="card-title">Kalkulasi Jam Kerja</h3>
                        <br>
            
                        <div style="float: left;">
                            <h5>Kalkulasi Bulan Ini</h5>
                            <h2>{{$totalBulanIni}}</h2>
                        </div>

                        <div style="float: right;">
                            <h5>Kalkulasi Tahun Ini</h5>
                            <h2>{{$totalTahunIni}}</h2>
                        </div>
                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$address ?? '-'}}</td>
                                                <td>{{$hrd->deskripsi_kegiatan ?? '-'}}</td>
                                                <td><img src="data:image/png;base64,{{$hrd->url_gambar}}" alt="Image"></td>
                                                @if($hrd->id_approval == 1)
                                                    <td>Approved</td>
                                                @else
                                                    <td>Rejected</td>
                                                @endif
